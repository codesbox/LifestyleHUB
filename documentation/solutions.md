...
2. Совместимость: Корутины совместимы с существующими архитектурными компонентами Android, такими как ViewModel, Room,
   что упрощает их использование в нашем приложении.
...
Ktor предоставляет легковесное и мощное решение для работы с сетевыми запросами. Ktor Client легко интегрируется с
корутинами, сериализацией. Ktor Client встроенно поддерживает асинхронные операции
...
1. Интеграция с Jetpack Compose: Jetpack Compose Navigation разработан специально для интеграции с Jetpack Compose, что
...
3. Навигационные возможности: Jetpack Compose Navigation предоставляет широкие возможности для управления навигацией,
